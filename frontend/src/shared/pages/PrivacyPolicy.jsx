...
export default function PrivacyPolicy() {
  ...
  // Ensure theme matches local storage
  useEffect(() => {
  ...
  return (
    <div className="relative min-h-[100dvh] w-full overflow-y-auto overflow-x-hidden bg-[#f4f4f5] dark:bg-[#09090b] text-zinc-900 dark:text-zinc-100 transition-colors duration-500 flex flex-col font-sans">
          ...
          <div className="bg-white/60 dark:bg-[#121214]/80 backdrop-blur-xl border border-zinc-200 dark:border-white/10 rounded-3xl p-6 md:p-10 lg:p-12 shadow-xl">
            ...
            <div>
              ...
              <div className="space-y-4 text-sm md:text-base text-zinc-700 dark:text-zinc-300 leading-relaxed">
                <p>
                  By registering an account with VisionPark, we securely collect essential operational data, including your <strong className="text-zinc-900 dark:text-white">Name, Phone Number, Email, and Vehicle License Plate</strong>.
                </p>
                <p>
                  In absolute compliance with Article 26 of the FDRE Constitution:
                </p>
            ...
            <div className="mt-12 pt-8 border-t border-zinc-200 dark:border-white/10 flex justify-center">
              {/* Since they open this in a new tab, "Close Window" is better than "Back" */}
              <button 
