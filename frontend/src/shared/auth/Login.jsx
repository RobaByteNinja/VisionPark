...
import { Eye, EyeOff, Mail, Lock, AlertCircle, Loader2, Check } from "lucide-react"; // ✅ ADDED: Check icon
  ...
  const onSubmit = async (e) => {
    ...
    setTimeout(() => {
      ...
      if (userEmail.includes("owner")) {
        ...
        navigate("/attendant"); // We will build this later!
      } else {
        navigate("/driver/map");
      }
    }, 1500);
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    placeholder="admin@visionpark.io"
                    required
                    disabled={isLoading}
