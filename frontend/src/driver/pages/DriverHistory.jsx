...
import { 
  ...
  X, Wallet, PlusCircle, Loader2, Download 
} from "lucide-react";
...
export default function DriverHistory() {
  ...
  useEffect(() => { 
    document.body.style.overflow = selectedReceipt || downloadStatus ? "hidden" : "unset"; 
    return () => { document.body.style.overflow = "unset"; }; 
  }, [selectedReceipt, downloadStatus]);
  ...
  return (
    <div className="relative h-[100dvh] flex flex-col overflow-hidden bg-[#f4f4f5] dark:bg-[#09090b]">
      <div className="h-24 flex-shrink-0" />
      <div className="flex-1 overflow-y-auto px-4 md:px-8 pb-32 md:pb-40 overscroll-contain" onScroll={handleScroll}>
        <div className="mx-auto max-w-md md:max-w-2xl lg:max-w-3xl flex flex-col gap-8">
          ...
          <div className="relative w-full max-w-sm md:max-w-md lg:max-w-lg bg-white dark:bg-[#121214] border border-zinc-200 dark:border-white/10 rounded-3xl shadow-2xl max-h-[85vh] flex flex-col animate-in zoom-in-95 duration-300" onClick={(e) => e.stopPropagation()}>
              ...
              <div className="flex flex-col gap-3 mt-6 lg:mt-8">
                ...
                <div className="bg-zinc-50 dark:bg-black/40 rounded-xl p-4 md:p-5 text-left border border-zinc-200 dark:border-white/5">
                  <p className="text-sm md:text-base lg:text-lg text-zinc-500 dark:text-zinc-400 mb-1 flex justify-between gap-4">
                    <span className="shrink-0">Paid From:</span> <span className="text-zinc-900 dark:text-white font-bold text-right">{selectedReceipt.paymentMethod}</span>
                  </p>
            ...
            <div className="p-6 md:p-8 pt-2 border-t border-zinc-200 dark:border-white/10 shrink-0">
              <div className="flex flex-col sm:flex-row gap-3 md:gap-4">
                ...
                <button 
                  type="button" 
                  onClick={(e) => { e.preventDefault(); handleNavigate(selectedReceipt.lat, selectedReceipt.lon); }} 
